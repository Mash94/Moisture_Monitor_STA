...
STATIC const PINMUX_GRP_T pinmuxing[] = {
	...
	{0,  22,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 1 */
	{0,  17,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 0 */
	{2,   2,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 2 */
	{2,   3,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 3 */
	{2,   4,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 4 */
	{0,   4,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 5 */
	{2,  11,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 6 */
	{2,  12,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Led 7 */
	{1,  31,  IOCON_MODE_INACT | IOCON_FUNC3},	/* ADC 5 */
	{0,  26,  IOCON_MODE_INACT | IOCON_FUNC1},
...
//	{0x1, 27, IOCON_MODE_INACT | IOCON_FUNC1},	/* CLKOUT */
	...
	/* Tact Switches. */
	{0, 18,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Pulsador externo 1 SW2 */
	{0, 1 ,  IOCON_MODE_INACT | IOCON_FUNC0},	/* Pulsador externo 2 SW3 */
